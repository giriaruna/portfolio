      ...
      <div className="max-w-6xl mx-auto px-6 md:px-12 lg:px-20">
        ...
        <div className="flex flex-col space-y-12 items-stretch justify-center md:space-x-16 md:space-y-0 md:flex-row md:text-left">
          ...
          <div className="md:w-1/2">
            <h2 className="text-center text-2xl md:text-3xl font-bold mb-6 text-indigo-600 dark:text-indigo-400 md:text-left">
              Get to know me!
            </h2>
            ...
            <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
              ...
              My interests span <span className="text-indigo-500 font-semibold">machine learning</span>,{" "}
              <span className="text-indigo-500 font-semibold">data science</span>, and{" "}
              <span className="text-indigo-500 font-semibold">full-stack development</span>.
            </p>
            <br />
            <p className="text-lg leading-relaxed text-gray-700 dark:text-gray-300">
              ...
              <span className="font-bold text-indigo-600 dark:text-indigo-400">continuous growth</span>.
            </p>
          </div>
          ...
          <div className="md:w-1/2 text-center md:text-left relative">
            {/* Technical Skills */}
            <h2 className="text-2xl md:text-3xl font-bold mb-4 text-indigo-600 dark:text-indigo-400">
              Technical Skills
            </h2>
            <div className="flex flex-wrap gap-3 justify-center md:justify-start mb-8">
              {technicalSkills.map((item, idx) => (
                <p
                  key={idx}
                  className="bg-gray-200 dark:bg-gray-800 px-4 py-2 text-gray-700 dark:text-gray-300 rounded-lg font-medium shadow-sm hover:scale-105 transform transition"
                >
                  {item}
                </p>
              ))}
